    ...
    <vertical>
        ...
        <viewpager id="vv">
            <vertical>
                ...
                <frame height="100" gravity="center" padding="22 8 30 8">
                    <text text="重要说明:只做技术交流,请勿传播使用,随时封号,后果自负!" gravity="center" textSize="20sp"/>
                </frame>
                <text id="wws" text="" textSize="16sp" />
                
                <button id="yjx" text="运行一键学" w="140" h="70" circle="true" layout_gravity="center" style="Widget.AppCompat.Button.Colored" textSize="18sp" />
            ...
            <vertical>
                <horizontal>
                    ...
                    <button id="xtsz" w="100" text="系统权限" />
                    <button id="xfc" w="100" text="悬浮窗权限" />
                </horizontal>
                <horizontal>
                    <text text="系统设置:" gravity="left" />
                    <button id="sjcx" w="100" text="更新版本" />
                    <button id="rzs" w="100" text="系统日志" />
                </horizontal>
                ...
                <horizontal>
                    ...
                    <button id="fz" w="100" text="复制用户名" />
                    <button id="ok" w="100" text="登陆" />
                </horizontal>
            </vertical>
        </viewpager>
    </vertical>
